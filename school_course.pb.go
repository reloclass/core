...
// 	protoc        v3.14.0
// source: relo/core/school_course.proto
...
type SchoolCourse struct {
	...
	CourseType int32 `protobuf:"varint,1,opt,name=course_type,json=courseType,proto3" json:"courseType" validate:"required" oneof:"1 3 4"`
	//  上课模式
	// 1：智慧课堂
	// 2：双师模式
	// 3：会议模式
	// @gotags: json:"classMode" validate:"omitempty" oneof:"1 3 4"
	ClassMode int32 `protobuf:"varint,2,opt,name=class_mode,json=classMode,proto3" json:"classMode" validate:"omitempty" oneof:"1 3 4"`
	// 最大上课人数
	...
	CourseResolution Resolution `protobuf:"varint,4,opt,name=course_resolution,json=courseResolution,proto3,enum=relo.core.Resolution" json:"courseResolution" validate:"omitempty"`
}

func (x *SchoolCourse) Reset() {
	*x = SchoolCourse{}
...
func (x *SchoolCourse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SchoolCourse) ProtoMessage() {}

func (x *SchoolCourse) ProtoReflect() protoreflect.Message {
	mi := &file_relo_core_school_course_proto_msgTypes[0]
...
// Deprecated: Use SchoolCourse.ProtoReflect.Descriptor instead.
func (*SchoolCourse) Descriptor() ([]byte, []int) {
	return file_relo_core_school_course_proto_rawDescGZIP(), []int{0}
}

func (x *SchoolCourse) GetCourseType() int32 {
	if x != nil {
		return x.CourseType
	}
	return 0
...
func (x *SchoolCourse) GetClassMode() int32 {
	if x != nil {
		return x.ClassMode
	}
	return 0
...
func (x *SchoolCourse) GetStudentNumber() int32 {
	if x != nil {
...
func (x *SchoolCourse) GetCourseResolution() Resolution {
	if x != nil {
		return x.CourseResolution
	}
...
var file_relo_core_school_course_proto_rawDesc = []byte{
	...
	0x6f, 0x6c, 0x5f, 0x63, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12,
	0x09, 0x72, 0x65, 0x6c, 0x6f, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x22, 0xb9, 0x01, 0x0a, 0x0c, 0x53,
	0x63, 0x68, 0x6f, 0x6f, 0x6c, 0x43, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x63,
	0x6f, 0x75, 0x72, 0x73, 0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05,
	0x52, 0x0a, 0x63, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1d, 0x0a, 0x0a,
	0x63, 0x6c, 0x61, 0x73, 0x73, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05,
	...
	0x65, 0x72, 0x12, 0x42, 0x0a, 0x11, 0x63, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x5f, 0x72, 0x65, 0x73,
	0x6f, 0x6c, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x15, 0x2e,
	0x72, 0x65, 0x6c, 0x6f, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x6c, 0x75,
	0x74, 0x69, 0x6f, 0x6e, 0x52, 0x10, 0x63, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x52, 0x65, 0x73, 0x6f,
	0x6c, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x2a, 0x77, 0x0a, 0x0a, 0x52, 0x65, 0x73, 0x6f, 0x6c, 0x75,
	...
	0x07, 0x12, 0x0c, 0x0a, 0x08, 0x4f, 0x52, 0x49, 0x47, 0x49, 0x4e, 0x41, 0x4c, 0x10, 0x0f, 0x42,
...
var file_relo_core_school_course_proto_goTypes = []interface{}{
	(Resolution)(0),      // 0: relo.core.Resolution
	(*SchoolCourse)(nil), // 1: relo.core.SchoolCourse
}
var file_relo_core_school_course_proto_depIdxs = []int32{
	0, // 0: relo.core.SchoolCourse.course_resolution:type_name -> relo.core.Resolution
